...
class HttpSmokeTests(unittest.TestCase):
    ...
    def test_root_serves_current_embedded_frontend(self):
        ...
        self.assertIn('id="marketFlowOverviewSvg"', html)
        self.assertIn("行业资金结构", html)
        self.assertIn("drawMarketFlowOverview", html)
        ...
        self.assertIn("const duration=920", html)
        self.assertNotIn("大盘强弱传导 · 粒子动效", html)
        self.assertIn("watch-head", html)
        self.assertIn('id="watchFocusFilter"', html)
        self.assertIn("toggleWatchFocusHidden", html)
        self.assertIn("toggleWatchFocus", html)
        ...
        self.assertIn("柱长采用对数缩放", html)
        self.assertIn("priceAction.regime", html)
        self.assertIn("近期波段详情", html)
        self.assertIn("item.label||'波段点'", html)
        self.assertIn("已确认震荡区间", html)
        self.assertIn("未确认", html)
        self.assertIn("borderType:'dashed'", html)
        self.assertNotIn("formatter:item.code", html)
        self.assertNotIn("formatter:'可能支撑 {c}'", html)
        self.assertNotIn("formatter:'可能压力 {c}'", html)
        self.assertNotIn("formatter:'成本密集区 {c}'", html)
        self.assertNotIn("markPoint:{silent:true,data:marks.points}", html)
